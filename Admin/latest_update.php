      ...
      <section class="wrapper">
        ...
        <div class="row mt">
          <div class="col-lg-12">
            ...
            <div class="form-panel">
              <div class="form">
                <form class="cmxform form-horizontal style-form" id="signupForm" method="POST" action="latest_update_code.php">
                  <div class="form-group ">
                    <label for="firstname" class="control-label col-lg-2">Date</label>
                    <div class="col-lg-10">
                      <input class=" form-control" id="firstname" name="date" type="date" />
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="lastname" class="control-label col-lg-2">Subject</label>
                    <div class="col-lg-10">
                      <input class=" form-control" id="lastname" name="subject" type="text" />
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="username" class="control-label col-lg-2">Latest Update</label>
                    <div class="col-lg-10">
                      <input class="form-control " id="username" name="latest_update" type="text" />
                    </div>
                  </div>
                  <!-- <div class="form-group ">
                  ...
                  <div class="form-group">
                    <div class="col-lg-offset-2 col-lg-10">
                      <button class="btn btn-theme" name="btn_submit" type="submit">Save</button>
                      <button class="btn btn-theme04" type="button">Cancel</button>
                    </div>
                  </div>
                </form>
